...
function 𝚍species╱𝚍t!(species, t, Par::Parameters)
    ...
    if event == "birth"
        ...
        P𝛅 = [Par.δ[1] * g.total_synonymous_mutations, 
                Par.δ[2] * (1 + 4t/1000 ) * g.total_APOBEC3_mutations, 
...
BSON.@save "data/special_simulated_$(label)_$(rand_label).bson" sampled_DNA time_points Par N_t
...
savefig(P, "figures/special_simulated_$(label)_$(rand_label).png")
savefig(P, "figures/special_simulated_$(label)_$(rand_label).pdf")